...
class StartArgs:
    ...
    pd_trans_mode: str = field(default="nccl", metadata={"choices": ["nccl", "nixl", "mooncake"]})
    ...
    disable_npu_mm_all_reduce: bool = field(default=False)
    extra_ops_plugins: Optional[str] = field(default=None)
    extra_ops_modules: Optional[str] = field(default=None)
    extra_ops_fallback: Optional[str] = field(default=None)
    extra_sampling_plugins: Optional[str] = field(default=None)
    extra_sampling_modules: Optional[str] = field(default=None)
    extra_sampling_fallback: Optional[str] = field(default=None)
    extra_att_plugins: Optional[str] = field(default=None)
    extra_att_modules: Optional[str] = field(default=None)
